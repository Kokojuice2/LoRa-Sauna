...
const int thresholdTemp = 21;   //thermostaat waarde
float temp, vocht;
...
//***************_RGB LED  als thermostaat_**************
    ...
    #define ROODPIN  13        //Rood    -->   verwarming staat aan
...
//******************_Licht schakelaar_*******************
    ...
    int lichtStatus = LOW;      // huidige status lichtpin
...
static uint8_t mydata[17] = {0x01,0x67,0x00,0x00,0x02,0x68,0x00,0x03,0x65,0x00,0x00,0x04,0x1,0x00,0x05,0x1,0x00};          // bekijk de data type en structuur op      // meer info bij void alldata()
